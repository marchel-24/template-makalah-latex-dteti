...
The main contributions of this work are: (1) an interactive VR simulation system integrating house design exploration with real-time electricity consumption estimation; (2) an energy estimation module based on Bottom-Up Appliance Modeling that accurately distinguishes usage scenarios; and (3) an AI-powered schedule personalization feature using an LLM to assist users in making energy-efficient decisions.
